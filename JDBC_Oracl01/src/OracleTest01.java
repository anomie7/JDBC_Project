	...
	public static void main(String[] args){
		...
		while(true){
			...
			if(command.equals("list")){
				...
				String sql = "update employee set eno = ?, ename = ?, job = ?, manager = ?, hiredate = to_date(?, 'YYYYMMDD'), salary = ?, commission = ?, dno = ?";
				new OracleManager(i1, s1, s2, i2, s3, i3, i4, i5).update(sql);
